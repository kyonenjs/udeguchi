...
const download_simple_quiz = async ({content, object_index, chapter_path, auth_headers}) => {
	...
	const instruction = content.description ? `<div class="alert" role="alert"><h4><strong><i class="fa fa-sticky-note-o" aria-hidden="true"></i> Instructions</strong></h4><div class="alert" role="alert" style="background-color: #E9FBE9;border-left: 8px solid #52E052;">${content.description}</div></div>` : '';
